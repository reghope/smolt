#!/usr/bin/env bash
# Build DOOM for smolt-doom using doomgeneric and Emscripten
...
cp "$DOOM_DIR/doomgeneric_smolt.c" "$DOOM_DIR/doomgeneric/doomgeneric/"
