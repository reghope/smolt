...
import type { AssistantMessage, Context, Model } from "@smolt/ai";
...
vi.mock("@smolt/ai/compat", async (importOriginal) => {
	const actual = await importOriginal<typeof import("@smolt/ai/compat")>();
	return {
		...actual,
...
describe("generateSummary reasoning options", () => {
	...
	it("leaves Anthropic refusal fallback handling to smolt-ai model metadata", async () => {
		await generateSummary(
			messages,
