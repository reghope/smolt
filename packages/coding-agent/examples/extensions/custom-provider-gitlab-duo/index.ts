 ...
 * Delegates to smolt-ai's built-in Anthropic and OpenAI streaming implementations.
 *
 * Usage:
 *   smolt -e ./packages/coding-agent/examples/extensions/custom-provider-gitlab-duo
...
export default function (smolt: ExtensionAPI) {
	smolt.registerProvider("gitlab-duo", {
