 ...
 *
 * Usage: smolt --extension ./examples/extensions/overlay-qa-tests.ts
 *
 * Commands:
...
export default function (smolt: ExtensionAPI) {
	...
	smolt.registerCommand("overlay-anchors", {
	...
	smolt.registerCommand("overlay-margins", {
	...
	smolt.registerCommand("overlay-stack", {
	...
	smolt.registerCommand("overlay-overflow", {
	...
	smolt.registerCommand("overlay-edge", {
	...
	smolt.registerCommand("overlay-percent", {
	...
	// Test maxHeight
	smolt.registerCommand("overlay-maxheight", {
	...
	smolt.registerCommand("overlay-sidepanel", {
	...
	smolt.registerCommand("overlay-toggle", {
	...
	smolt.registerCommand("overlay-passive", {
	...
	smolt.registerCommand("overlay-focus", {
	...
	smolt.registerCommand("overlay-streaming", {
