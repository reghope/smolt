...
import { Agent, type AgentMessage, setDefaultStreamFn, type ThinkingLevel } from "@smolt/agent-core";
import { clampThinkingLevel, type Message, type Model, streamSimple } from "@smolt/ai/compat";
...
// provider-agnostic and does not import smolt-ai/compat itself.
setDefaultStreamFn(streamSimple);

export interface CreateAgentSessionOptions {
	/** Working directory for project-local discovery. Default: process.cwd() */
	cwd?: string;
	/** Global config directory. Default: ~/.smolt/agent */
	agentDir?: string;
	 ...
	 *
	 * When omitted, smolt uses the `defaultTools` setting for the initial built-in
	...
	/** Per-tool options for the built-in tools (e.g. a default shell timeout). */
