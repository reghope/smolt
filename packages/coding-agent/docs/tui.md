...
**Source:** [`@smolt/tui`](https://github.com/earendil-works/pi-mono/tree/main/packages/tui)
...
Import from `@smolt/tui`:

```typescript
import { Text, Box, Container, Spacer, Markdown } from "@smolt/tui";
```
...
// Restore smolt's default spinner
ctx.ui.setWorkingIndicator();
```
