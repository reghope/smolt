...
const outputPath = join(tmpdir(), "smolt-browser-smoke.js");
const agentTreeshakeOutputPath = join(tmpdir(), "smolt-agent-treeshake-smoke.js");
const errorLogPath = join(tmpdir(), "smolt-browser-smoke-errors.log");
