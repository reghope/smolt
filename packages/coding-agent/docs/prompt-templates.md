...
Smolt loads prompt templates from:

- Global: `~/.smolt/agent/prompts/*.md`
- Project: `.smolt/prompts/*.md` (only after the project is trusted)
- Packages: `prompts/` directories or `smolt.prompts` entries in `package.json`
