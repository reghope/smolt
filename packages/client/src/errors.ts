import type { JsonValue, ProtocolError, ProtocolErrorCode } from "@smolt/protocol";
...
export class PiDisconnectedError extends Error {
	constructor(message = "Smolt client is disconnected") {
		super(message);
...
export class PiClientDisposedError extends Error {
	constructor() {
		super("Smolt client is disposed");
