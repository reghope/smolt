...
import type { Api, ImageContent, Model, TextContent } from "@smolt/ai";
...
function getSmoltDocsClassification(absolutePath: string): CompactReadClassification | undefined {
...
function getCompactReadClassification(
	...
	const docsClassification = getSmoltDocsClassification(absolutePath);
