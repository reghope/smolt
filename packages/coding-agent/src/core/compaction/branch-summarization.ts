...
import type { AgentMessage, StreamFn } from "@smolt/agent-core";
import type { RetryCallbacks, RetryPolicy } from "@smolt/ai";
import { contentText } from "@smolt/ai";
import type { Model, SimpleStreamOptions, Usage } from "@smolt/ai/compat";
import {
	convertToLlm,
...
export function prepareBranchEntries(entries: SessionEntry[], tokenBudget: number = 0): BranchPreparation {
	...
	// Only extract from smolt-generated summaries (fromHook !== true), not extension-generated ones
