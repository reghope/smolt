...
- The user's own Supabase project hosts the data, connected to smolt with /sites supabase. This site gets its own Postgres schema there. That is the whole backend: there is no server of yours to write and no host-side code to run.
