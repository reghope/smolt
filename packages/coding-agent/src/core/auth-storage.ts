 ...
 * Provider auth orchestration belongs to ModelRuntime and smolt-ai Models.
 */

import type { AuthOperationOptions, Credential, CredentialInfo, CredentialStore } from "@smolt/ai";
