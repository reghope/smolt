...
import { type Message, uuidv7 } from "@smolt/ai";
import type { ExtensionAPI, SessionEntry } from "@smolt/coding-agent";
import { BorderedLoader, convertToLlm, serializeConversation } from "@smolt/coding-agent";
