/**
 * Temporary compatibility entrypoint preserving the old global smolt-ai API
 ...
 *
 * Existing apps switch imports from "@smolt/ai" to
 * "@smolt/ai/compat" unchanged; new code uses `createModels()`
...
export * from "./api/smolt-messages.lazy.ts";
...
import { smoltMessagesApi } from "./api/smolt-messages.lazy.ts";
...
/** @deprecated Static catalog read. Use `getBuiltinModel` from "@smolt/ai/providers/all" or `Models.getModel()`. */
export const getModel = getBuiltinModel;

/** @deprecated Static catalog read. Use `getBuiltinModels` from "@smolt/ai/providers/all" or `Models.getModels()`. */
export const getModels = getBuiltinModels;

/** @deprecated Static catalog read. Use `getBuiltinProviders` from "@smolt/ai/providers/all" or `Models.getProviders()`. */
...
const BUILTIN_APIS: [Api, ProviderStreams][] = [
	...
	["smolt-messages", smoltMessagesApi()],
];
