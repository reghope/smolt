 ...
 * working indicator shown while smolt is streaming a response.
 *
 * Usage:
 *   smolt --extension examples/extensions/working-indicator.ts
 *
 * Commands:
...
export default function (smolt: ExtensionAPI) {
	...
	smolt.registerCommand("working-indicator", {
