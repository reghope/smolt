...
- [Using Smolt](usage.md) - interactive mode, slash commands, context files, and CLI reference.
...
- [Smolt packages](packages.md) - bundle and share extensions, skills, prompts, and themes.
...
- [Environment variables](environment-variables.md) - Smolt process configuration and session metadata available to bash tools.
