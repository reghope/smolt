...
import { Editor, type EditorTheme, Key, matchesKey, Text, visibleWidth, wrapTextWithAnsi } from "@smolt/tui";
...
export default function questionnaire(smolt: ExtensionAPI) {
	smolt.registerTool({
		name: "questionnaire",
		label: "Questionnaire",
		description:
