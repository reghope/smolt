import type { Api, AssistantMessage, Model, ToolCall, ToolResultMessage, UserMessage } from "@smolt/ai";
import { encodeServerMessage, PROTOCOL_VERSION } from "@smolt/protocol";
...
describe("smolt-ai protocol bridge", () => {
