...
import { Text, type TUI } from "@smolt/tui";
...
describe("ToolExecutionComponent parity", () => {
	...
	for (const scenario of [
		...
		{
			title: "AGENTS.md",
			path: join(process.cwd(), ".smolt", "AGENTS.md"),
			content: "Hidden resource instructions",
			compact: "read resource .smolt/AGENTS.md",
			hidden: "Hidden resource instructions",
			absent: undefined,
		},
		{
			title: "AGENTS.override.md",
			path: join(process.cwd(), ".smolt", "AGENTS.override.md"),
			content: "Hidden override instructions",
			compact: "read resource .smolt/AGENTS.override.md",
	...
	for (const scenario of [
		...
		{ title: "Smolt documentation", path: getReadmePath(), compact: "read docs README.md:120-329" },
	] as const) {
