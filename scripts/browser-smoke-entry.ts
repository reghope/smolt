...
import { createAssistantMessageEventStream, Type } from "@smolt/ai";
import { complete, getModel, getProviders, streamSimple } from "@smolt/ai/compat";
import {
	Agent,
	bashExecutionToText,
	convertToLlm,
...
import { decodeCbor, encodeCbor, PROTOCOL_VERSION } from "@smolt/protocol";
