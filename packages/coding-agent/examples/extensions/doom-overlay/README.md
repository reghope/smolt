...
Play DOOM as an overlay in smolt. Demonstrates that the overlay system can handle real-time game rendering at 35 FPS.

## Usage

```bash
smolt --extension ./examples/extensions/doom-overlay
```
...
- [smolt-doom](https://github.com/badlogic/smolt-doom) for the original smolt integration
