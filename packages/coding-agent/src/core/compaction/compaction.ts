...
import type { AgentMessage, StreamFn, ThinkingLevel } from "@smolt/agent-core";
import { contentText, type RetryCallbacks, type RetryPolicy, retryAssistantCall, uuidv7 } from "@smolt/ai";
import type { AssistantMessage, Context, Model, SimpleStreamOptions, Usage } from "@smolt/ai/compat";
import { completeSimple } from "@smolt/ai/compat";
...
function extractFileOperations(
	...
	// Collect from previous compaction's details (if smolt-generated)
