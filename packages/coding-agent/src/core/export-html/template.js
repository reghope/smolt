    (function() {
      ...
      const injectedParams = document.querySelector('meta[name="smolt-url-params"]');
      ...
      function buildShareUrl(entryId) {
        ...
        const baseUrlMeta = document.querySelector('meta[name="smolt-share-base-url"]');
      ...
      const SIDEBAR_WIDTH_STORAGE_KEY = 'smolt-share:v1:sidebar-width';
