 ...
 *
 *   mkdir -p ~/.smolt/agent/extensions
 *   cp packages/coding-agent/examples/extensions/project-trust.ts ~/.smolt/agent/extensions/
 *
 * Or:
 *
 *   smolt -e packages/coding-agent/examples/extensions/project-trust.ts
 *
...
export default function (smolt: ExtensionAPI) {
	...
	smolt.on("project_trust", async (event, ctx): Promise<ProjectTrustEventResult> => {
