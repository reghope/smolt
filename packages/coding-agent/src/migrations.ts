...
/**
 * Migrate sessions from ~/.smolt/agent/*.jsonl to proper session directories.
 *
 * Bug in v0.30.0: Sessions were saved to ~/.smolt/agent/ instead of
 * ~/.smolt/agent/sessions/<encoded-cwd>/. This migration moves them
 ...
 * Note: tools/ may contain fd/rg binaries extracted by smolt, so only warn if it has other files.
 */
