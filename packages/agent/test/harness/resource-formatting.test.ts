...
describe("resource formatting helpers", () => {
	it("formats skill invocations with additional instructions", () => {
		const skill = {
			...
			filePath: "/project/.smolt/skills/inspect/SKILL.md",
		};

		expect(formatSkillInvocation(skill, "Check errors.")).toBe(
			'<skill name="inspect" location="/project/.smolt/skills/inspect/SKILL.md">\nReferences are relative to /project/.smolt/skills/inspect.\n\nUse inspection tools.\n</skill>\n\nCheck errors.',
		);
	});
