 ...
 *   smolt -e ./packages/coding-agent/examples/extensions/custom-provider
 *
 *   # With API key
 *   CUSTOM_ANTHROPIC_API_KEY=sk-ant-... smolt -e ./packages/coding-agent/examples/extensions/custom-provider
 *
...
export default function (smolt: ExtensionAPI) {
	smolt.registerProvider("custom-anthropic", {
