...
export default defineConfig({
	...
	resolve: {
		alias: [
			{ find: /^@earendil-works\/smolt-telemetry$/, replacement: telemetryIndex },
			{ find: /^@earendil-works\/smolt-agent-core\/session\/testing$/, replacement: agentSessionTesting },
			{ find: /^@earendil-works\/smolt-agent-core\/node$/, replacement: agentNode },
			{ find: /^@earendil-works\/smolt-agent-core$/, replacement: agentIndex },
			{ find: /^@earendil-works\/smolt-ai$/, replacement: aiIndex },
		],
	},
});
