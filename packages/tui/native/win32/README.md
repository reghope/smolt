...
For non-Windows cross-builds, or for custom Windows toolchains, set `SMOLT_TUI_WIN32_TOOLCHAIN=mingw` and provide MinGW-compatible compilers:

```sh
SMOLT_TUI_WIN32_TOOLCHAIN=mingw \
