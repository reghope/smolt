...
/**
 * Converts models.dev verified effort values into Smolt's selectable thinking levels.
 * Values without a Smolt equivalent (`default` and JSON `null`) are intentionally
 * omitted.
 */
